...
def check_array_ndim(arr: np.ndarray, ndim: int) -> None:
    ...
    >>> import numpy as np
    >>> from analora.metric.utils import check_array_ndim
...
def check_label_type(label_type: str) -> None:
    ...
    >>> from analora.metric.utils import check_label_type
...
def check_nan_pred(y_true: np.ndarray, y_pred: np.ndarray) -> None:
    ...
    >>> import numpy as np
    >>> from analora.metric.utils import check_nan_pred
...
def check_same_shape(arrays: Iterable[np.ndarray]) -> None:
    ...
    >>> import numpy as np
    >>> from analora.metric.utils import check_same_shape
...
def check_same_shape_score(y_true: np.ndarray, y_score: np.ndarray) -> None:
    ...
    >>> import numpy as np
    >>> from analora.metric.utils import check_same_shape_score
    >>> y_true = np.array([1, 0, 0, 1])
...
def multi_isnan(arrays: Sequence[np.ndarray]) -> np.ndarray:
    ...
    >>> import numpy as np
    >>> from analora.metric.utils import multi_isnan
    >>> mask = multi_isnan(
...
def preprocess_pred_multilabel(
    ...
    >>> import numpy as np
    >>> from analora.metric.utils import preprocess_pred_multilabel
...
def preprocess_same_shape_arrays(
    ...
    >>> import numpy as np
    >>> from analora.metric.utils import preprocess_same_shape_arrays
    >>> arrays = [
...
def preprocess_score_multiclass(
    ...
    >>> import numpy as np
    >>> from analora.metric.utils import preprocess_score_multiclass
...
def preprocess_score_multilabel(
    ...
    >>> import numpy as np
    >>> from analora.metric.utils import preprocess_score_multilabel
    >>> y_true = np.array([[1, float("nan"), 1], [0, 1, 0], [0, 1, 0], [1, 0, 1], [1, 0, 1]])
    >>> y_score = np.array(
