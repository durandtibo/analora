...
from analora.testing import markdown_available
from analora.utils.text import markdown_to_html
...
def test_markdown_to_html_no_markdown() -> None:
    with (
        patch("analora.utils.text.is_markdown_available", lambda: False),
...
def test_markdown_to_html_no_markdown_ignore() -> None:
    with patch("analora.utils.text.is_markdown_available", lambda: False):
